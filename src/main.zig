...
pub fn main(init: std.process.Init) !void {
    ...
    try runner.runWithOptions(app.app(), .{
        .app_name ="Claude Feature Flag App",
        .window_title ="Claude Feature Flag App",
        .bundle_id ="dev.zero_native.claude-feature-flag-app",
...
test "app name is configured" {
    try std.testing.expectEqualStrings("claude-feature-flag-app","claude-feature-flag-app");
}
